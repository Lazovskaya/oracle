...
export default function PricingPage() {
  ...
  // EUR Price IDs
  const basicPriceIdEUR = process.env.STRIPE_BASIC_PRICE_ID_EUR || basicPriceId;
  const proPriceIdEUR = process.env.STRIPE_PRO_PRICE_ID_EUR || proPriceId;
  ...
  const priceIds = {
    ...
    proUSD: proPriceId,
    basicYearlyUSD: basicYearlyPriceId,
    proYearlyUSD: proYearlyPriceId,
    basicEUR: basicPriceIdEUR,
