...
const DUMMY_IDEAS = [
  // Winners
  {
    ...
    entry_date: '2024-12-01T10:00:00Z',
    exit_date: '2024-12-15T15:30:00Z',
  ...
  },
  {
    ...
    entry_date: '2024-12-05T09:00:00Z',
    exit_date: '2024-12-20T14:00:00Z',
    exit_reason: 'target_hit',
    status: 'winner',
  ...
  },
  {
    ...
    entry_date: '2024-11-20T10:30:00Z',
    exit_date: '2024-12-10T16:00:00Z',
    exit_reason: 'target_hit',
    status: 'winner',
    expected_timeframe: '2-4 weeks',
  ...
  },
  {
    ...
    entry_date: '2024-11-25T11:00:00Z',
    exit_date: '2024-12-18T13:00:00Z',
    exit_reason: 'target_hit',
    status: 'winner',
  ...
  },
  {
    ...
    entry_date: '2024-12-08T10:00:00Z',
    exit_date: '2024-12-28T15:00:00Z',
    exit_reason: 'target_hit',
    status: 'winner',
    expected_timeframe: '2-4 weeks',
  ...
  // Losers
  {
    ...
    entry_date: '2024-11-28T09:30:00Z',
    exit_date: '2024-12-05T14:00:00Z',
  ...
  },
  {
    ...
    entry_date: '2024-11-15T10:00:00Z',
    exit_date: '2024-11-22T13:30:00Z',
    exit_reason: 'stop_loss',
    status: 'loser',
    expected_timeframe: '3-5 weeks',
  ...
  },
  {
    ...
    entry_date: '2024-12-02T11:00:00Z',
    exit_date: '2024-12-12T10:00:00Z',
    exit_reason: 'stop_loss',
    status: 'loser',
    expected_timeframe: '2-4 weeks',
  ...
  // Breakeven
  {
    ...
    entry_date: '2024-12-10T09:30:00Z',
    exit_date: '2024-12-20T15:00:00Z',
  ...
  // Active trades
  {
    ...
    entry_date: '2025-01-05T10:00:00Z',
    status: 'active',
    expected_timeframe: '2-4 weeks',
  ...
  },
  {
    ...
    entry_date: '2025-01-08T11:30:00Z',
    status: 'active',
    expected_timeframe: '3-6 weeks',
